...
```
Remove/filter out the rows of Area that include more than just the year.
Change "N/A" values to NA then change NA to 0.
```{r}
...
![Commercial Line Fishery](QFISHplot.png)

Figure 3. Commercial line fishery catch data for various species from 1990 to 2023. Fishing methods plotted are listed. Data obtained from Department of Agriculture and Fisheries, QFish.