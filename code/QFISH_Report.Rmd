...
```{r}
#| fig.cap = "Figure 3. Commercial line fishery catch data for various species from 1990 to 2023. Fishing methods plotted are listed. Where there are points that do not connect, there was no data for those years for that method recorded. Fishing methods that were excluded from the plot due to having no tonnage collected include: Trap, Other, Diving, Danish Seine, Collection. Data obtained from Department of Agriculture and Fisheries, QFish."
